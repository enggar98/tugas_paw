        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                        <form method="post" action="cetak_sidang">
                                <!-- untuk modal select -->
                        ...
                        <div class="body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example">
                                    ...
                                    <tbody>
                                     <?php foreach($data_sidang->result() as $key => $val):?>
                                        <tr>
                                            <td><?php echo $val->id_daftar_sidang?></td>
                                            ...
                                            <td bgcolor="#ffff00">
                                                <b><?php echo $val->status_sidang?></b>
                                            </td>
                                            <td>
                                                <form method="post" action="ftambah_nilai_sidang">
                                                    <input type="hidden" name="id_daftar_sidang" value="<?php echo $val->id_daftar_sidang?>">
                                                    <input type="hidden" name="nim" value="<?php echo $val->nim?>">
                                                    <input type="submit" name="submit" value="Nilai Sidang" class="btn btn-info ">
                                                </form>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>

<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>FORM TAMBAH NILAI SEMINAR TA 2</h2>
                </div>
                <div class="body">
                    <form id="form_validation" method="POST" action="insert_nilai_seminarta2"> 
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" class="form-control" name="peminatan" value="<?php echo $peminatan?>" readonly>

<html>
<head>
    <title>Cetak Pendaftaran TA 2</title>
</head>
<body>
<h1 style="text-align: center;">Pendaftaran Tugas Akhir 2</h1>
...
if( ! empty($daftarta2)){
    $no = 1;
    foreach($daftarta2->result() as $data){
        echo "<tr>";
        echo "<td>".$no."</td>";
        echo "<td>".$data->nim."</td>";
        ...
        echo "<td>".$data->status_daftarta2."</td>";
        echo "</tr>";

<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>FORM PENDAFTARAN SIDANG TUGAS AKHIR</h2>
                </div>
                <?php
                    if($status_sidang =="Acc")
                    {
                        ?>
                             <center><label><h1>Anda Telah Daftar Sidang</h1></label></center>
                             <center>
                             <form method="post" action="cetak_sidang_mhs">
                                <?php echo "<input type='hidden' name='id_daftar_sidang' value='$id_daftar_sidang'>"?>
                    ...
                    <?php } ?>
                    <form id="form_validation" action="insert_sidang" method="POST" enctype="multipart/form-data">

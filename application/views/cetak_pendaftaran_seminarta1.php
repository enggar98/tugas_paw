<html>
<head>
    <title>Cetak Pendaftaran Seminar TA 1</title>
</head>
<body>
<h1 style="text-align: center;">Pendaftaran Seminar Tugas Akhir 1</h1>
...
if( ! empty($seminarta1)){
    $no = 1;
    foreach($seminarta1->result() as $data){
        echo "<tr>";
        echo "<td>".$no."</td>";
        echo "<td>".$data->nim."</td>";
        ...
        echo "<td>".$data->status_seminarta1."</td>";
        echo "</tr>";

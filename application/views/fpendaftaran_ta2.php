...
<html>
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    DATA PENDAFTARAN TUGAS AKHIR 2
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                        <form method="post" action="cetak_daftarta2">
                                <!-- untuk modal select -->
                        ...
                        <div class="body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example">
                                    ...
                                    <tbody>
                                     <?php foreach($data_daftarta2->result() as $key => $val):?>
                                        <tr>
                                            <td><?php echo $val->id_daftar_ta2?></td>
                                            ...
                                            <td bgcolor="#ffff00">
                                                <b><?php echo $val->status_daftarta2?></b>
                                            </td>
                                            <td>
                                                <form method="post" action="ftambah_nilai_daftarta1">
                                                    <input type="hidden" name="id_daftar_ta2" value="<?php echo $val->id_daftar_ta2?>">
                                                    <input type="hidden" name="nim" value="<?php echo $val->nim?>">
                                                    <input type="submit" name="submit" value="Nilai TA 2" class="btn btn-info ">
                                                </form>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>

...
<html>
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    DATA PENDAFTARAN SEMINAR TUGAS AKHIR 1
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                        <form method="post" action="cetak_seminarta1">
                                <!-- untuk modal select -->
                        ...
                        <div class="body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example">
                                    ...
                                    <tbody>
                                     <?php foreach($data_seminarta1->result() as $key => $val):?>
                                        <tr>
                                            <td><?php echo $val->id_daftar_seminarta1?></td>
                                            ...
                                            <td><a href="<?php echo base_url().'file/'.$val->file_berkas?>" class="btn btn-info" download>Download</a></td>
                                            ...
                                            <td bgcolor="#ffff00">
                                                <b><?php echo $val->status_seminarta1?></b>
                                            </td>
                                            <td><form method="post" action="ftambah_nilai_seminarta1">
                                                    <input type="hidden" name="id_daftar_seminarta1" value="<?php echo $val->id_daftar_seminarta1?>">

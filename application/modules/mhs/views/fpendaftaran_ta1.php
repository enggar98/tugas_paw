<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>FORM PENDAFTARAN PENDAFTARAN TA 1 </h2>
                </div>
                <?php
                    if($status == "Acc")
                    {
                        ...
                        ?>
                            <center><label><h1>Anda Telah Daftar TA 1 </h1></label></center>
                            <center>
                             <form method="post" action="cetak_daftarta1_mhs">
                                <?php echo "<input type='hidden' name='id_daftar_ta1' value='$id_daftar_ta1'>"?>
                    ...
                    <?php } ?>
                    <form id="form_validation" action="insert_pendaftaran_ta1" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                ...
                                <select class="form-control show-tick" name="dosen_pem1" required>
                                    <option value="">-- Pilih --</option>
                                    <?php
                                      foreach($dosen as $datadosen) {

                                        echo "<option  value='".$datadosen[0]."|".$datadosen[1]."'>".$datadosen[1]."</option>'";
                                        }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                ...
                                <select class="form-control show-tick" name="dosen_pem2" required>
                                    <option value="">-- Pilih --</option>
                                    <?php
                                      foreach($dosen as $datadosen) {
                        ...
                        <?php
                            ...
                            foreach ($periode as $dataperiode) {
                                if ($dataperiode[0] == "pendaftaran_ta1") {

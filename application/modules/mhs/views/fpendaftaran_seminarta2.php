<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>FORM PENDAFTARAN SEMINAR TA 2</h2>
                </div>
                <?php
                    if($status_seminarta2 =="Acc")
                    {
                        ?>
                             <center><label><h1>Anda Telah Daftar Seminar TA 2</h1></label></center>
                             <center>
                             <form method="post" action="cetak_seminarta2_mhs">
                                <?php echo "<input type='hidden' name='id_daftar_seminarta2' value='$id_daftar_seminarta2'>"?>
                    ...
                    <?php } ?>
                    <form id="form_validation" action="insert_seminarta2" method="POST" enctype="multipart/form-data">

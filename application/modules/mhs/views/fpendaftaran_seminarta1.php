<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>FORM PENDAFTARAN SEMINAR TA 1</h2>
                </div>
                <?php
                    if($status_seminarta1 =="Acc")
                    {
                        ?>
                             <center><label><h1>Anda Telah Daftar Seminar TA 1</h1></label></center>
                             <center>
                             <form method="post" action="cetak_seminarta1_mhs">
                                <?php echo "<input type='hidden' name='id_daftar_seminarta1' value='$id_daftar_seminarta1'>"?>
                    ...
                    <?php } ?>
                    <form id="form_validation" action="insert_seminarta1" method="POST" enctype="multipart/form-data">
